...
const CheckoutForm = (param)=>{
    ...
    const handleSubmitOrder = async ()=>{
        ...
        try {
            ...
            const slugsFromItems = items.filter((item)=>!item.warehouseProduct).map((item)=>{
                var _getProductById;
                return (_getProductById = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProductById"])(item.productId)) === null || _getProductById === void 0 ? void 0 : _getProductById.slug;
            }).filter((s)=>!!s);
            const uniqueSlugs = Array.from(new Set(slugsFromItems));
            const slugToProduct = {};
            await Promise.all(uniqueSlugs.map(async (slug)=>{
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$product$2f$productApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchCatalogProductRaw"])(slug);
                if (data) slugToProduct[slug] = data;
            }));
            const positions = items.map((item)=>{
                var _productData_warehouse_items;
                ...
                if (productData === null || productData === void 0 ? void 0 : (_productData_warehouse_items = productData.warehouse_items) === null || _productData_warehouse_items === void 0 ? void 0 : _productData_warehouse_items.length) {
                    var _this;
                    ...
                    var _uuid;
                    const rawId = (_uuid = (_this = warehouseItem) === null || _this === void 0 ? void 0 : _this.uuid) !== null && _uuid !== void 0 ? _uuid : warehouseItem === null || warehouseItem === void 0 ? void 0 : warehouseItem.id;
...
//# sourceMappingURL=src_03a1605d._.js.map