            ...
            const positions = await Promise.all(items.map(async (item)=>{
                ...
                try {
                    ...
                    if (productResponse.ok) {
                        ...
                        if ((_productData_warehouse_items = productData.warehouse_items) === null || _productData_warehouse_items === void 0 ? void 0 : _productData_warehouse_items.length) {
                            ...
                            var _warehouseItem_uuid;
                            const rawId = (_warehouseItem_uuid = warehouseItem === null || warehouseItem === void 0 ? void 0 : warehouseItem.uuid) !== null && _warehouseItem_uuid !== void 0 ? _warehouseItem_uuid : warehouseItem === null || warehouseItem === void 0 ? void 0 : warehouseItem.id;
...
//# sourceMappingURL=src_3cc0bf75._.js.map