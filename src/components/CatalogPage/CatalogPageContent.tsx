...
const CatalogPageContent = ({ title, products }: CatalogPageContentProps) => {
    ...
    const categoriesRef = useRef<HTMLNavElement | null>(null);
    ...
    const handleMouseDown = (e: React.MouseEvent<HTMLNavElement>) => {
    ...
    const handleMouseMove = (e: React.MouseEvent<HTMLNavElement>) => {
