...
const ProductPageView = ({ product }: ProductPageViewProps) => {
    ...
    const [openSection, setOpenSection] = useState<string | null>(() => {
        return product.sections.length > 0
            ? product.sections[0]?.id ?? null
            : null;
    });
                                ...
                                <div className={styles.sizeGuideContent}>
                                    ...
                                    {sizeGuideSection.content
                                        ...
                                        .map((paragraph, index) => (
                                            <p
                                                key={index}
                                                className={styles.sizeGuideText}
                                            >
                                                {paragraph}
                                            </p>
                                        ))}
                                    ...
                                    >
                                        <button
                                            ...
                                            className={`${
                                                ...
                                                isSelected
                                                    ? styles.accordionButtonSelected
                                                    : ""
                                            } ${
                                                isOpen
                                                    ? styles.accordionButtonOpen
                                                    : ""
                                            }`}
                                            onClick={() =>
