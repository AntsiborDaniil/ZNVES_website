...
const CATALOG_CATEGORIES = [
  ...
  { label: "Pants", href: "/catalog?category=pant" },
  { label: "Jeans", href: "/catalog?category=jean" },
  { label: "T-Shirt", href: "/catalog?category=t-shirt" },
  { label: "Zip Hoodies", href: "/catalog?category=zip-hoodie" },
  { label: "Jackets", href: "/catalog?category=jacket" },
  { label: "Hoodies", href: "/catalog?category=hoodie" },
  { label: "Shorts", href: "/catalog?category=short" },
] as const;
      ...
      >
        ...
        <div className={styles.menuContent}>
          <div className={styles.menuSectionNavigation}>
            ...
            <div className={styles.menuSection}>
              <button
                className={`${styles.menuHeader} ${styles.menuHeaderButton} ${
