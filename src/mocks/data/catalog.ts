...
const PRODUCT_SEEDS: MockProductSeed[] = [
  {
    ...
    price: "22900",
    is_new: true,
    image: "/images/catalogs/mock/ski-suit-1.webp",
    gallery: [
      "/images/catalogs/mock/ski-suit-1.webp",
      "/images/catalogs/mock/ski-suit-2.webp",
      "/images/catalogs/mock/ski-suit-m.webp",
    ],
    colors: ["black", "navy"],
    sizes: ["s", "m", "l", "xl"],
    variants: [
  ...
  },
  {
    ...
    price: "4490",
    is_new: true,
    image: "/images/catalogs/mock/bag-1.webp",
    gallery: [
      "/images/catalogs/mock/bag-1.webp",
      "/images/catalogs/mock/bag-2.webp",
      "/images/catalogs/mock/bag-m.webp",
    ],
    colors: ["green", "gray"],
    sizes: ["s", "m"],
    variants: [
  ...
  },
  {
    ...
    price: "3390",
    is_new: true,
    image: "/images/catalogs/mock/bag-low-1.webp",
    gallery: [
      "/images/catalogs/mock/bag-low-1.webp",
      "/images/catalogs/mock/bag-low-2.webp",
    ],
    colors: ["green", "sand"],
    sizes: ["s", "m"],
    variants: [
